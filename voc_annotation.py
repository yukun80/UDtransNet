...
trainval_percent = 1
train_percent = 0.1  # 进行定量分析时设置为0，让验证集所有数据都包含进去
...
if __name__ == "__main__":
    ...
    # 定量验证评估数据集
    # segfilepath = os.path.join("../DataCollection", "6_Eva", "CZ", "segfB2_CZ5km_256_231228", "png")
    # saveBasePath = os.path.join("../DataCollection", "6_Eva", "CZ", "segfB2_CZ5km_256_231228", "List")

    # # 选取无滑坡样本的数据集
    segfilepath = os.path.join("../DataCollection", "3_MaskData", "JinS", "_Val_sample_png_256")
    saveBasePath = os.path.join("../DataCollection", "3_MaskData", "JinS", "_Val_sample_png_256", "List")

    # 如果saveBasePath不存在则创建
